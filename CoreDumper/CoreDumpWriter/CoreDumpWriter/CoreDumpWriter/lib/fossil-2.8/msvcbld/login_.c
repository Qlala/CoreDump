  ...
  if( g.zLogin ){
    ...
    if( P("HTTPS")==0 ){
      ...
      if( g.sslNotAvailable ){
        cgi_printf("No encrypted connection is available on this server.\n");
      }else{
...
void register_page(void){
  ...
  ** email alerts and if the default permissions include "7" */
  ...
  cgi_printf("<p><input type=\"hidden\" name=\"captchaseed\" value=\"%u\" />\n"
         ...
         "  <td><input type=\"text\" name=\"u\" value=\"%h\" size=\"30\"></td>\n"
         "\n",(uSeed),(zUserID));
  if( iErrLine==1 ){
  ...
  cgi_printf("<tr>\n"
         ...
         "  <td><input type=\"text\" name=\"dn\" value=\"%h\" size=\"30\"></td>\n"
         "</tr>\n",(zDName));
  if( iErrLine==2 ){
    cgi_printf("<tr><td><td><span class='loginError'>&uarr; %h</span></td></tr>\n",(zErr));
  }
  cgi_printf("</tr>\n"
         ...
         "  <td><input type=\"text\" name=\"ea\" value=\"%h\" size=\"30\"></td>\n"
         "</tr>\n",(zEAddr));
  if( iErrLine==3 ){
    cgi_printf("<tr><td><td><span class='loginError'>&uarr; %h</span></td></tr>\n",(zErr));
  }
  ...
  cgi_printf("<tr>\n"
         ...
         "  <td><input type=\"password\" name=\"p\" value=\"%h\" size=\"30\"></td>\n"
         "<tr>\n",(zPasswd));
  if( iErrLine==4 ){
    cgi_printf("<tr><td><td><span class='loginError'>&uarr; %h</span></td></tr>\n",(zErr));
  }
  cgi_printf("<tr>\n"
         ...
         "  <td><input type=\"password\" name=\"cp\" value=\"%h\" size=\"30\"></td>\n"
         "</tr>\n",(zConfirm));
  if( iErrLine==5 ){
    cgi_printf("<tr><td><td><span class='loginError'>&uarr; %h</span></td></tr>\n",(zErr));
  }
