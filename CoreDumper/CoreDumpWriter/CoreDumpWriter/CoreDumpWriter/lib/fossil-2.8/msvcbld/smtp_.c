...
void setup_smtp(void){
  ...
  cgi_printf("<h1>Email Routing Table</h1>\n"
  ...
  while( db_step(&q)==SQLITE_ROW ){
    ...
    cgi_printf("<tr>\n"
           " <td valign=\"top\">%h</td>\n"
           " <td valign=\"top\"><span style=\"white-space:pre;\">%h</span></td>\n"
           " <td valign=\"top\"><form method=\"POST\" action=\"%R/setup_smtp_route\">\n"
           "   <input type=\"hidden\" name=\"oaddr\" value=\"%h\">\n"
           "   <input type=\"submit\" value=\"Edit\">\n"
           "   </form>\n",(zEAddr),(zEPolicy),(zEAddr));
  }
  db_finalize(&q);
  cgi_printf("<tr>\n"
         "  <td colspan=\"3\">\n"
...
smtp_route_edit:
  ...
  cgi_printf("<form method=\"POST\" action=\"%R/setup_smtp_route\">\n");
  if( zOAddr ){
    cgi_printf("<input type=\"hidden\" name=\"oaddr\" value=\"%h\">\n",(zOAddr));
  }
  cgi_printf("<table class=\"label-value\">\n"
         "<tr>\n"
         "  <th>Email Address:</th>\n"
         "  <td><input type=\"text\" size=30 name=\"eaddr\" value=\"%h\">\n",(zEAddr));
  if( iErr==1 ){
    cgi_printf("<td><span class=\"generalError\">&larr; %z</span>\n",(zErr));
  }
  cgi_printf("</tr>\n");
  ...
  cgi_printf("<tr>\n"
         "  <th>Routing:</th>\n"
         "  <td><textarea name=\"epolicy\" rows=\"3\" cols=\"40\">%h</textarea>\n",(zEPolicy));
  if( iErr==2 ){
    cgi_printf("<td valign=\"top\"><span class=\"generalError\">&larr; %z</span>\n",(zErr));
  }
  cgi_printf("</tr>\n"
         "<tr>\n"
         "  <td>&nbsp;\n"
