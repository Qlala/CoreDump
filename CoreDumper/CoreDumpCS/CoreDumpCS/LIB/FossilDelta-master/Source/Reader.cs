...
namespace Fossil
{
  ...
  public class StreamReader
  {
	...
	public Stream BaseStream { get => baseStream; set => baseStream = value; }

	public StreamReader(Stream BaseStream_a)
	{
	  baseStream = BaseStream_a;
	}
	...
	public byte GetByte()
	{
	  byte b = (byte)baseStream.ReadByte();
